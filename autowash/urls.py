            ...
            try:
                ...
                if business:
                    ...
                    if not hasattr(business, 'subscription') or not business.subscription:
                        # Business doesn't have any subscription - redirect to subscription selection
                        print(f"Business has no subscription, redirecting to subscription selection")
                        return HttpResponseRedirect('/subscriptions/select/')
                    elif business.subscription and not business.subscription.is_active:
                        # Business has expired subscription - redirect to renewal/upgrade
                        print(f"Business has expired subscription, redirecting to subscription renewal")
...
urlpatterns = [
    ...
    path('subscriptions/', include('apps.subscriptions.urls')),  # Includes both public and business context URLs
